...
# Try pushing a large file to master - should fail due to limit_filesize hook
  ...
  remote:   Error:
  remote:     hooks failed:
  remote:     limit_filesize for 8e1abc616627abff95c42a990ee914e7cb6a2bcf: File size limit is 5 bytes. You tried to push file large_file that is over the limit (18 bytes, 3.60x the limit). This limit is enforced for files matching the following regex: ".*".
  remote: 
