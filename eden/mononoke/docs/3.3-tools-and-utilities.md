...
The repo_import tool handles repository import with additional capabilities beyond basic gitimport. It supports:
...
This tool is used for complex import scenarios where simple gitimport is insufficient.
...
The import directory contains shared libraries and utilities used by various import tools (gitimport, repo_import). These are not standalone tools but provide common functionality for repository imports.
