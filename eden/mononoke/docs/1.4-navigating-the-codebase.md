...
All BUCK files start with `oncall("scm_server_treehugger")` to designate ownership. This is standard across the entire codebase.
...
**Key patterns**:
- `oncall("scm_server_treehugger")` appears in every file
