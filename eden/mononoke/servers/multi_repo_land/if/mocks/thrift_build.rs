...
eden/mononoke/servers/multi_repo_land/if/multi_repo_land.thrift crate //eden/mononoke/servers/multi_repo_land/if:multi_repo_land_if-rust
...
fn main() {
    ...
    Config::from_env(GenContext::Mocks)
        ...
        .base_path("../../../../../..")
        .types_crate("multi_repo_land_if__types")
        .clients_crate("multi_repo_land_if__clients")
        .options("default_enum_zero,serde")
        .run(["../multi_repo_land.thrift"])
