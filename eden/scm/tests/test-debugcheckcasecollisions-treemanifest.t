...
Check basic case collisions
  $ sorted sl debugcheckcasecollisions DIRA/subdira/FILE1 DIRA/SUBDIRB/file2 DIRB/FILE3
  DIRA (directory for DIRA/SUBDIRB/file2) conflicts with dirA
  DIRB (directory for DIRB/FILE3) conflicts with dirB
  [1]
  $ LC_ALL=C sorted sl debugcheckcasecollisions dirA/subdirA/FILE1 dirA/SUBDIRB/file2 dirB/FILE3
...
Check a dir that collides with a file
  $ sl debugcheckcasecollisions FILE4/foo
  FILE4 (directory for FILE4/foo) conflicts with file4
  [1]

Check a file that collides with a dir
  $ sl debugcheckcasecollisions DIRb
  DIRb conflicts with dirB
  [1]

Check self-conflicts
  $ sl debugcheckcasecollisions newdir/newfile NEWdir/newfile newdir/NEWFILE
...
Check against a particular revision
  $ sl debugcheckcasecollisions -r 'desc(base)' FILE4
...
being checked, and it gets passed a list of file adds)
  ...
  $ sl commit -Aqm new
  $ sl debugcheckcasecollisions dirA/subdirA/file10
