...
Prepare Repo:
  ...
  $ sl push -r $C --to master --create -q
  $ sl push -r $E --to master --create -q --config paths.default=test:e2
  $ sl push -r $H --to master --create -q --config paths.default=test:e3

Clone:

  $ cd $TESTTMP
#if pulllazy-python
  $ sl clone -q test:e3 cloned
#else
  $ sl clone -q test:e3 cloned
#endif
  $ cd cloned
...
Pull:
  ...
  $ LOG=pull::fastpath=debug sl pull
...
Test DAG flushed but not metalog (Emulates Ctrl+C or SIGKILL in between):
  ...
  $ setconfig paths.default=test:e2
  $ FAILPOINTS=transaction-metalog-commit=return LOG=pull::fastpath=debug sl pull
  pulling from test:e2
  DEBUG pull::fastpath: master: 26805aba1e600a82e93661149f2313866a221a7b => 9bc730a19041f9ec7cb33c626e811aa233efb18c
  imported commit graph for 2 commits (1 segment)
...
Fast path can still be used with stale remotenames:
  ...
  $ LOG=pull::fastpath=debug,dag::protocol=debug  sl pull
  ...
  $ EDENSCM_DISABLE_REMOTE_RESOLVE=0000000000000000000000000000000000000000 LOG=dag::protocol=debug sl log -Gr 'all()' -T '{desc} {remotenames}'
...
If fast path is broken, use fallback pull path:
  ...
  $ setconfig paths.default=test:e2
  $ FAILPOINTS="eagerepo::api::pulllazy=return;eagerepo::api::commitgraphsegments=return" LOG=pull::fastpath=debug sl pull
  pulling from test:e2
  DEBUG pull::fastpath: master: 26805aba1e600a82e93661149f2313866a221a7b => 9bc730a19041f9ec7cb33c626e811aa233efb18c
