...
Make sure we don't have tree fetches for the "excluded/" directory:
  $ LOG=manifest_tree=trace sl st --config devel.watchman-reset-clock=true 2>&1 | grep f2b0dbe6584d49d20752468d0c644fb6f117e76a
  [1]
