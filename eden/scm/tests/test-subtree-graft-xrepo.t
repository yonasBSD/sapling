...
Test subtree prefetch with an invalid commit hash
  $ newclientrepo
  $ sl subtree prefetch --url $GIT_URL --rev aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
Test subtre prefetch
  $ sl subtree prefetch --url $GIT_URL --rev 22cc654c7242ce76728ac8baaab057e3cdf7e024
...
Test subtree graft
  $ sl subtree graft --url $GIT_URL --rev 22cc654c7242ce76728ac8baaab057e3cdf7e024 --from-path "" --to-path mygitrepo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  ...
  $ sl subtree prefetch --url $GIT_URL --rev main
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  From file:/*/$TESTTMP/gitrepo (glob)
   * [new ref]         e815a5c1f80404f40f8fe492f461e91b4cc0e976 -> remote/main
subtree graft a range of commits should work
  $ sl subtree graft --url $GIT_URL --rev 0e0bbd7f53d7f8dfa9ef6283f68e2aa5d274a185::2d03d263ac7869815998b556ccec69eb36edebda --from-path "" --to-path mygitrepo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  ...
  ~  Grafted 0e0bbd7f53d7f8dfa9ef6283f68e2aa5d274a185 from file:/*/$TESTTMP/gitrepo (glob)
     ...
     +1a
      ...
      3
      4
  $ sl subtree graft --url $GIT_URL --rev e815a5c1f80404f40f8fe492f461e91b4cc0e976 --from-path "" --to-path mygitrepo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
...
Test subtree graft with merge conflicts
  ...
  > EOS
  $ sl go $B -q
  $ sl subtree graft --url $GIT_URL --rev 0e0bbd7f53d7f8dfa9ef6283f68e2aa5d274a185 --from-path "" --to-path foo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  grafting 0e0bbd7f53d7 "G2"
  merging foo/a.txt and a.txt to foo/a.txt
  warning: 1 conflicts while merging foo/a.txt! (edit, then use 'sl resolve --mark')
...
Test subtree graft without --from-path
  ...
  > EOS
  $ sl go $A -q
  $ sl subtree graft --url $GIT_URL --rev 0e0bbd7f53d7f8dfa9ef6283f68e2aa5d274a185 --to-path foo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  grafting 0e0bbd7f53d7 "G2"
  $ sl log -G -T '{desc}\n' -p -r .
  @  Graft "G2"
...
test subtree graft with renames on the destination side (not optimal)
  ...
  > EOS
  $ sl go $B -q
  $ sl subtree graft --url $GIT_URL --rev 0e0bbd7f53d7f8dfa9ef6283f68e2aa5d274a185 --to-path foo --config ui.interactive=true -- << EOF
  > r
  > foo/a2.txt
  > EOF
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
...
test subtree graft with renames on the source side
  ...
  > EOS
  $ sl go $A -q
  $ sl subtree graft --url $GIT_URL --rev e815a5c1f80404f40f8fe492f461e91b4cc0e976 --to-path foo
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  grafting e815a5c1f804 "G4"
  $ sl log -G -T '{desc}\n' -p -r .
  @  Graft "G4"
