...
Status compared to parent of the working copy, i.e. the dirstate status
  ...
  $ sl status -A --rev 'desc(second)' 'glob:missing_content2_content3-tracked'
  M missing_content2_content3-tracked
  $ sl status -A --rev 'desc(second)' 'glob:missing_content2_content2-tracked'
  C missing_content2_content2-tracked
  $ sl status -A --rev 'desc(second)' 'glob:missing_missing_content3-tracked'
  A missing_missing_content3-tracked
  $ sl status -A --rev 'desc(second)' 'glob:missing_missing_content3-untracked'
  ? missing_missing_content3-untracked
  $ sl status -A --rev 'desc(second)' 'glob:missing_content2_*-untracked'
  R missing_content2_content2-untracked
  R missing_content2_content3-untracked
  R missing_content2_missing-untracked
  $ sl status -A --rev 'desc(second)' 'glob:missing_*_missing-tracked'
  ! missing_content2_missing-tracked
  ! missing_missing_missing-tracked

  $ sl status -A --rev 'desc(second)' 'glob:missing_missing_missing-untracked'
  missing_missing_missing-untracked: $ENOENT$

Status between first and second commit. Should ignore dirstate status.

  $ sl status -A --rev 'desc(first)':'desc(second)' 'glob:content1_content2_*'
  ...
  $ sl status -A --rev 'desc(first)':'desc(second)' 'glob:content1_content1_*'
  ...
  $ sl status -A --rev 'desc(first)':'desc(second)' 'glob:missing_content2_*'
  ...
  $ sl status -A --rev 'desc(first)':'desc(second)' 'glob:content1_missing_*'
  ...
  $ sl status -A --rev 'desc(first)':'desc(second)' 'glob:missing_missing_*'
...
is correctly combined with the inter-revision status
  ...
  $ sl status -A --rev 'desc(first)' 'glob:content1_*_content[23]-tracked'
  M content1_content1_content3-tracked
  M content1_content2_content2-tracked
  M content1_content2_content3-tracked
  M content1_missing_content3-tracked
  $ sl status -A --rev 'desc(first)' 'glob:content1_*_content1-tracked'
  C content1_content1_content1-tracked
  C content1_content2_content1-tracked
  C content1_missing_content1-tracked
  $ sl status -A --rev 'desc(first)' 'glob:missing_*_content?-tracked'
  A missing_content2_content2-tracked
  A missing_content2_content3-tracked
  A missing_missing_content3-tracked
BROKEN: missing_content2_content[23]-untracked exist, so should be listed
  $ sl status -A --rev 'desc(first)' 'glob:missing_*_content?-untracked'
  ? missing_missing_content3-untracked
  $ sl status -A --rev 'desc(first)' 'glob:content1_*_*-untracked'
  ...
  R content1_missing_content3-untracked
  R content1_missing_missing-untracked
  $ sl status -A --rev 'desc(first)' 'glob:*_*_missing-tracked'
  ! content1_content1_missing-tracked
  ! content1_content2_missing-tracked
  ! content1_missing_missing-tracked
  ! missing_content2_missing-tracked
  ! missing_missing_missing-tracked
  $ sl status -A --rev 'desc(first)' 'glob:missing_*_missing-untracked'
