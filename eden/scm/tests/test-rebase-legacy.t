...
# rebasestate generated by a legacy client running "sl rebase -r B+D+E+G+H -d Z"

  $ touch .sl/last-message.txt
  $ cat > .sl/rebasestate << 'EOF'
  ...
  $ sl log -G -T '{rev}:{node|short} {desc}\n'
  o  14:fc52970345e8 D
  │
  o  13:eac96551b107 B
  │
