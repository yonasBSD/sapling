...
#require no-eden
  ...
  >     sl ci -m 'does not commute with e' -d '7 0'
  >     cd ..
  > }
...
Initial generation of the command files
  ...
  $ sl log --template 'fold {node|short} {desc}\n' -r 'desc(does)' >> $EDITED
...
edit the history
  $ sl histedit 092e4ce14829f4974399ce4316d59f64ef0b6725 --commands $EDITED 2>&1 | fixbundle
...
fix up
  ...
  $ HGEDITOR=cat sl histedit --continue 2>&1 | fixbundle | grep -v '2 files removed'
  d
  ***
...
Initial generation of the command files
  ...
  $ sl log --template 'pick {node|short} {desc}\n' -r 092e4ce14829f4974399ce4316d59f64ef0b6725 >> $EDITED
  $ sl log --template 'pick {node|short} {desc}\n' -r ae78f4c9d74ffa4b6cb5045001c303fe9204e890 >> $EDITED
  $ sl log --template 'roll {node|short} {desc}\n' -r 'desc(does)' >> $EDITED
  $ sl log --template 'pick {node|short} {desc}\n' -r 7f3755409b009372829d4180bfecef5c5bb3a10e >> $EDITED
  $ sl log --template 'pick {node|short} {desc}\n' -r 'desc(f)' >> $EDITED
  $ cat $EDITED
  pick 092e4ce14829 c
...
fix up
  ...
  (no more unresolved files)
  continue: sl histedit --continue
  $ sl histedit --continue 2>&1 | fixbundle | grep -v '2 files removed'
  merging e
  warning: 1 conflicts while merging e! (edit, then use 'sl resolve --mark')
  Fix up the change (pick 7f3755409b00)
  (sl histedit --continue to resume)
