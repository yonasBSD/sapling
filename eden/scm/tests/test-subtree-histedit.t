...
test histedit to fold subtree merge commits
  ...
  │
  o  b4cb27eee4e2 A
  $ sl histedit 23b8d4a76647 --commands - <<EOF
  ...
  (use 'sl fold' to combine subtree commits)
  [255]
  $ sl histedit 23b8d4a76647 --commands - <<EOF
  > pick 23b8d4a76647 merge B from foo to foo2
