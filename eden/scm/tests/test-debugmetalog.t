...
# GNU General Public License version 2.
  ...
  $ sl debugmetalogroots -v | tee out
  ...
  $ HGFORCEMETALOGROOT=$(grep debugdrawdag out | head -1 | sed 's/.*\+0000 (.{40}) debugdrawdag.*/\1/') sl log -G -r 'all()' -T '{desc} {bookmarks}'
  o  E E
  │
  o  D D
  │
  ...
  $ sl debugcompactmetalog

  $ sl debugmetalogroots -v
