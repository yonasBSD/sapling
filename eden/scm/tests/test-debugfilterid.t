...
# Single path, Legacy Filters
  $ sl debugfilterid --rev 38723ede98cf632e4f029acb8c0a166dcc6f8eee filter/file1
  filter/file1:38723ede98cf632e4f029acb8c0a166dcc6f8eee (no-eol)

# Multiple paths, Legacy Filters
  $ sl debugfilterid --rev 38723ede98cf632e4f029acb8c0a166dcc6f8eee filter/file1 filter/file2
...
# Single path, V1 Filters
  $ sl debugfilterid --rev 38723ede98cf632e4f029acb8c0a166dcc6f8eee filter/file1 | python -c 'import sys; print(sys.stdin.buffer.read())'
  b'\x01\x01\x08v\xf6\xa7\xfb\xec5\xe1`'

# Multiple paths, V1 Filters
  $ sl debugfilterid --rev 38723ede98cf632e4f029acb8c0a166dcc6f8eee filter/file1 filter/file2 | python -c 'import sys; print(sys.stdin.buffer.read())'
