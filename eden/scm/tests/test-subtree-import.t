...
Test subtree import failure cases
  ...
  $ sl subtree import --url $GIT_URL --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0 --to-path foo -m "import gitrepo to foo"
  abort: cannot import to an existing path: foo
  (use --force to overwrite)
  [255]
  $ sl subtree import --url $GIT_URL --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0
  abort: must specify the to-path
  [255]
  $ sl subtree import --url $GIT_URL --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0 --from-path dir1 --to-path bar --from-path dir2 --to-path bar/dir2
  abort: overlapping --to-path entries
  [255]
  $ sl subtree import --url $GIT_URL --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0 --to-path bar -m "import gitrepo to bar" --config subtree.min-path-depth=2
  abort: path should be at least 2 levels deep: 'bar'
  [255]
  $ sl subtree import --url file://$TESTTMP/gitrepo --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0 --to-path bar -m "import gitrepo to bar" --config subtree.min-path-depth=2
  abort: unable to determine git url from 'file:/*/$TESTTMP/gitrepo' (glob)
  [255]
  $ sl subtree import --url $GIT_URL --rev b6c31add3e60ded7a9c9c803641edffb1dccd251 --from-path nonexistent_dir --to-path bar
...
Test subtree import the root path of the external repo
  ...
  $ sl subtree import --url $GIT_URL --rev d2a8b3fa3dfa345ea64e02ea014d21b5cabd03e0 --to-path bar -m "import gitrepo to bar"
...
Test subtree import a sub directory of the external repo
  ...
  $ sl subtree import --url $GIT_URL --rev 4487c56011495a40ce2f6c632c24ae57a210747d --from-path dir2 --to-path mydir2 -m "import gitrepo/dir2 to mydir2"
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  From file:/*/$TESTTMP/gitrepo (glob)
...
Test subtree import with branch name
  ...
  > EOS
  $ sl go $A -q
  $ sl subtree import --url $GIT_URL --rev main --to-path bar -m "import gitrepo to bar"
  using cached git repo at $TESTTMP/default-hgcache/gitrepos/* (glob)
  copying / to bar
  $ sl subtree inspect
  {
